...
extern int JPEG_Decoder_ReadImage (JPEG_Decoder *decoder, const unsigned char **data, volatile OSL_IMAGE *out, int outWidth, int outHeight);
...
extern int JPEG_DecompressImage (const unsigned char *data, volatile OSL_IMAGE *out, int outWidth, int outHeight);
